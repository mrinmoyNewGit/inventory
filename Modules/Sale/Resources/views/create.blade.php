                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" name="customer_id" id="customer_id" required>
                                            @foreach(\Modules\People\Entities\Customer::orderBy('id', 'desc')->get() as $customer)

                                            <option value="{{ $customer->id }}">{{ $customer->customer_name }}</option>
                                            @endforeach
                                        </select>
                                        <div class="input-group-append">
                                            <button data-toggle="modal" data-target="#customerCreateModal" class="btn btn-outline-primary" type="button">
                                                Add
                                            </button>
                                        </div>
                                    </div>
...
@include('sale::partials.customer-modal')
@endsection
